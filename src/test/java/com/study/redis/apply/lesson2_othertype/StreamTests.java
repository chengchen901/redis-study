 ...
 * @since 2020/12/13
 */
public class StreamTests extends RedisApplyApplicationTests {
    ...
    public void producer() throws InterruptedException {
        RedisClient redisClient = RedisClient.create("redis://192.168.254.160:6379");
    ...
    public void consumerGroup() {
        ...
        for (StreamMessage<String, String> message : xreadgroup) {
            System.out.println("分组得到消息，并且ack消息："+message);
            // 告知redis，消息已经完成了消费
